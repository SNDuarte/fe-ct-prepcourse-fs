...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   var numeroMasGrande=Math.max(...arrayOfNums)
...
function cuentoElementos(array) {
   ...
   // Tu código:
   var mayA18=array.filter((num)=>num>18)
   return mayA18.length
   //var mayA18=0;
...
function mayorACien(array) {
   ...
   return newArray
   //var newArray=array.filter(mayor100 => mayor100 > 100);
   //return newArray
}
